 ...
 * $_ENV - Contains information about he environment variables.
 * $_FILES - contains infroamtion about files uploaded to the script.
 * $_REQUEST - contains inforamtion about variables passed through the from or URL.
 */
